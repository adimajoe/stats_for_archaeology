...
\begin{figure}[hbt!]
    \centering
    \includegraphics[width=1\linewidth]{univariate_plot_eg.pdf}
...
%\begin{figure}[hbt!]
%    \centering
%    \includegraphics[width=0.5\linewidth]{pokharia_pie_graph_eg.png}
%    \caption{Example of pie charts from \protect\hyperlink{pokharia}{Pokharia et al., 2017}}
%    \label{fig:pokharia_plot}
%\end{figure}

%\begin{figure}[hbt!]
%    \centering
%    \includegraphics[width=0.5\linewidth]{histogram_eg.png}
 %   \caption{Example of Histogram from \protect\hyperlink{prabhakar}{Prabhakar, 2013}}
 %   \label{fig:prabhakar_plot}
%\end{figure}
